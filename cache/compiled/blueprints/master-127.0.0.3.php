...
return [
    ...
    'timestamp' => 1515873739,
    'checksum' => '5b3a1dc58178072fd06167021bcb6364',
    'files' => [
        ...
        'user/plugins' => [
            ...
            'plugins/shoppingcart-2checkout-dev' => [
                'file' => 'user/plugins/shoppingcart-2checkout-dev/blueprints.yaml',
                'modified' => 1515873258
            ],
            'plugins/shoppingcart-paypal' => [
                'file' => 'user/plugins/shoppingcart-paypal/blueprints.yaml',
                'modified' => 1515873410
            ],
            'plugins/tntsearch' => [
    ...
    'data' => [
        'items' => [
            ...
            'plugins.shoppingcart-2checkout-dev.enabled' => [
                'type' => 'toggle',
                'label' => 'Plugin status',
                'highlight' => 1,
                'default' => 0,
                ...
                'name' => 'plugins.shoppingcart-2checkout-dev.enabled',
                'validation' => 'loose'
            ],
            'plugins.shoppingcart-2checkout-dev.payment' => [
                'type' => '_parent',
                'name' => 'plugins.shoppingcart-2checkout-dev.payment',
                'form_field' => false
            ],
            'plugins.shoppingcart-2checkout-dev.payment.methods' => [
                'type' => '_parent',
                'name' => 'plugins.shoppingcart-2checkout-dev.payment.methods',
                'form_field' => false
            ],
            'plugins.shoppingcart-2checkout-dev.payment.methods.twocheckout' => [
                'type' => '_parent',
                'name' => 'plugins.shoppingcart-2checkout-dev.payment.methods.twocheckout',
                'form_field' => false
            ],
            'plugins.shoppingcart-2checkout-dev.payment.methods.twocheckout.sandbox' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.shoppingcart-2checkout-dev.payment.methods.twocheckout.sandbox',
                'validation' => 'loose'
            ],
            'plugins.shoppingcart-2checkout-dev.payment.methods.twocheckout.name' => [
                'type' => 'hidden',
                'default' => 'twocheckout',
                'name' => 'plugins.shoppingcart-2checkout-dev.payment.methods.twocheckout.name',
                'validation' => 'loose'
            ],
            'plugins.shoppingcart-2checkout-dev.payment.methods.twocheckout.sellerID' => [
                'type' => 'text',
                'default' => '',
                'label' => '2checkout Seller ID',
                'size' => 'medium',
                'name' => 'plugins.shoppingcart-2checkout-dev.payment.methods.twocheckout.sellerID',
                'validation' => 'loose'
            ],
            'plugins.shoppingcart-paypal' => [
                'type' => '_root',
            ...
            'plugins.shoppingcart-paypal.enabled' => [
                'type' => 'toggle',
                'label' => 'PLUGIN_ADMIN.PLUGIN_STATUS',
                'highlight' => 1,
                'default' => 0,
                ...
                'name' => 'plugins.shoppingcart-paypal.enabled',
                'validation' => 'loose'
            ],
            'plugins.shoppingcart-paypal.test_mode' => [
                'type' => 'toggle',
                'label' => 'Test mode',
                'highlight' => 0,
                'default' => 0,
                ...
                'name' => 'plugins.shoppingcart-paypal.test_mode',
                'validation' => 'loose'
            ],
            'plugins.shoppingcart-paypal.payment' => [
                'type' => '_parent',
                'name' => 'plugins.shoppingcart-paypal.payment',
                'form_field' => false
            ],
            'plugins.shoppingcart-paypal.payment.methods' => [
                'type' => '_parent',
                'name' => 'plugins.shoppingcart-paypal.payment.methods',
                'form_field' => false
            ],
            'plugins.shoppingcart-paypal.payment.methods.paypal_express' => [
                'type' => '_parent',
                'name' => 'plugins.shoppingcart-paypal.payment.methods.paypal_express',
                'form_field' => false
            ],
            'plugins.shoppingcart-paypal.payment.methods.paypal_express.name' => [
                'type' => 'hidden',
                'default' => 'PayPal Express',
                'name' => 'plugins.shoppingcart-paypal.payment.methods.paypal_express.name',
                'validation' => 'loose'
            ],
            'plugins.shoppingcart-paypal.payment.methods.paypal_express.username' => [
                'type' => 'text',
                'default' => '',
                'label' => 'Username',
                'size' => 'medium',
                'name' => 'plugins.shoppingcart-paypal.payment.methods.paypal_express.username',
                'validation' => 'loose'
            ],
            'plugins.shoppingcart-paypal.payment.methods.paypal_express.password' => [
                'type' => 'text',
                'default' => '',
                'label' => 'Password',
                'size' => 'medium',
                'name' => 'plugins.shoppingcart-paypal.payment.methods.paypal_express.password',
                'validation' => 'loose'
            ],
            'plugins.shoppingcart-paypal.payment.methods.paypal_express.signature' => [
                'type' => 'text',
                'default' => '',
                'label' => 'Signature',
                'size' => 'medium',
                'name' => 'plugins.shoppingcart-paypal.payment.methods.paypal_express.signature',
                'validation' => 'loose'
            ],
            'plugins.tntsearch' => [
                'type' => '_root',
        ...
        'nested' => [
            ...
            'plugins' => [
                ...
                'shoppingcart-2checkout-dev' => [
                    'enabled' => 'plugins.shoppingcart-2checkout-dev.enabled',
                    'payment' => [
                        'methods' => [
                            'twocheckout' => [
                                'sandbox' => 'plugins.shoppingcart-2checkout-dev.payment.methods.twocheckout.sandbox',
                                'name' => 'plugins.shoppingcart-2checkout-dev.payment.methods.twocheckout.name',
                                'sellerID' => 'plugins.shoppingcart-2checkout-dev.payment.methods.twocheckout.sellerID'
                            ]
                        ]
                    ]
                ],
                'shoppingcart-paypal' => [
                    'enabled' => 'plugins.shoppingcart-paypal.enabled',
                    'test_mode' => 'plugins.shoppingcart-paypal.test_mode',
                    'payment' => [
                        'methods' => [
                            'paypal_express' => [
                                'name' => 'plugins.shoppingcart-paypal.payment.methods.paypal_express.name',
                                'username' => 'plugins.shoppingcart-paypal.payment.methods.paypal_express.username',
                                'password' => 'plugins.shoppingcart-paypal.payment.methods.paypal_express.password',
                                'signature' => 'plugins.shoppingcart-paypal.payment.methods.paypal_express.signature'
                            ]
                        ]
                    ]
                ],
