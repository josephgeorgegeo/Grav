...
return [
    ...
    'timestamp' => 1515874033,
    'checksum' => 'ca79a63684949ce82224bbfb136334c8',
    'files' => [
        'user/config' => [
            'media' => [
            ...
            'plugins/frontend-edit-button' => [
                'file' => 'user/config/plugins/frontend-edit-button.yaml',
                'modified' => 1515872847
            ],
            ...
            'plugins/shoppingcart-2checkout-dev' => [
                'file' => 'user/config/plugins/shoppingcart-2checkout-dev.yaml',
                'modified' => 1515873273
            ],
            'plugins/shoppingcart-paypal' => [
                'file' => 'user/config/plugins/shoppingcart-paypal.yaml',
                'modified' => 1515873424
            ],
            'plugins/tntsearch' => [
        ...
        'user/plugins' => [
            ...
            'plugins/frontend-edit-button' => [
                'file' => 'user/plugins/frontend-edit-button/frontend-edit-button.yaml',
                'modified' => 1515869381
            ],
            'plugins/langswitcher' => [
            ...
            'plugins/shoppingcart-2checkout-dev' => [
                'file' => 'user/plugins/shoppingcart-2checkout-dev/shoppingcart-2checkout-dev.yaml',
                'modified' => 1515873258
            ],
            'plugins/shoppingcart-paypal' => [
                'file' => 'user/plugins/shoppingcart-paypal/shoppingcart-paypal.yaml',
                'modified' => 1515873410
            ],
            'plugins/tntsearch' => [
